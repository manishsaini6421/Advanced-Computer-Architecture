...
EXEC="./emp"   # C++ binary built from emb.cpp
OUTPUT_DIR="perf_prefetching"

# These arrays should be expanded as necessary
EMBED_SIZES=(1000000 2000000 3000000 4000000 5000000 6000000 7000000 8000000 10000000)
PREFETCH_DISTANCES=(2 4 8 16 32 64)
